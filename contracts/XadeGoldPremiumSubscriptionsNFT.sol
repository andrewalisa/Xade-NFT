...
contract XadeGoldPremiumSubscriptionsNFT is
    ERC165,
    IERC721,
    IERC721Metadata,
    ReentrancyGuard,
    Ownable
{
    ...
    // Token name
    string private constant _name = "Xade Gold Premium Subscriptions";

    // Token symbol
    string private constant _symbol = "XGLD";
    ...
    // Mint Price
    uint256 public mintPrice = 75 ether; // price in native token (EX: Ether for Ethereum, MATIC for Polygon, etc.)

    // Token ID starts from 1 instead of 0
    uint256 private _nextTokenId = 1;

    // State Variable for allowListEnabled
    bool public allowListEnabled = false;

    // State Variable for discountEnabled
    ...
    string private _baseURI =
        "ipfs://bafybeiennck75zarsmjc6jvfj2xuq76g3rimwlrszefffydwaxzt6yzgeq/";
